...
@DataJpaTest
@Import(CommentsDaoJpaImpl.class)
class CommentsDaoJpaTest {

    @Autowired
    private CommentsDaoJpaImpl commentsDaoJpa;
    ...
    void findByIdTest() {
        ...
        Comment expectedComment = commentsDaoJpa.findById(1).get();
    ...
    void findAllTest() {
        ...
        List<Comment> expectedCommentsList = commentsDaoJpa.findAll();
    ...
    void updateTest() {
        ...
        commentsDaoJpa.update(actualComment);
        em.refresh(actualComment);
        Comment expectedAuthor = commentsDaoJpa.findById(1).get();
