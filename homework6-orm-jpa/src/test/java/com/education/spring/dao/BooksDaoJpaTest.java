...
@DataJpaTest
@Import(BooksDaoJpaImpl.class)
public class BooksDaoJpaTest {

    @Autowired
    private BooksDaoJpaImpl booksDaoJpa;
    ...
    public void findByNameTest() {
        ...
        List<Book> expectedBookList = booksDaoJpa.findByName("Маленький принц");
    ...
    public void findByAllTest() {
        ...
        em.persist(book1);
        em.persist(book2);
        List<Book> expectedBooksList = booksDaoJpa.findAll();
